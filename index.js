...
var objArray =[{name: "Kalvin", isInstructor:true},
                {name: "Tom", isInstructor:true},
                {name: "Gabby", isInstructor:true}]
...
console.log(addKeyAndValue([{name: 'Jackson'},{name: 'Abby'},{name: 'Anthony'}], "isInstructor", true))
